        ...
        <main className="min-h-screen aurora-background">
            ...
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
                    ...
                    <motion.div variants={sectionAnimation} className="flex flex-col lg:col-span-2">
                        <motion.span
                        ...
                        <motion.h1 variants={itemAnimation} className="text-4xl md:text-5xl font-heading mb-4">
                            {product.title}
                        </motion.h1>
                        <motion.p variants={itemAnimation} className="text-lg text-muted-foreground mb-8">
                            {product.description}
                        </motion.p>

                        <motion.div variants={itemAnimation} className="space-y-4 mb-10">
                            <h3 className="font-semibold text-xl font-heading">What&apos;s Included:</h3>
                        ...
                        >
                            <div className="flex flex-col sm:flex-row items-center justify-between">
                                ...
                                <Button
                                    asChild
                                    size="lg"
                                    className="h-14 text-lg font-semibold w-full sm:w-auto rounded-full"
                                >
                                    <a href={product.superProfileUrl} target="_blank" rel="noopener noreferrer">
            ...
            {relatedProducts.length > 0 && (
                ...
                >
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl md:text-5xl font-bold text-center mb-12 font-heading">
                            You Might Also Like
                        </h2>
